<!DOCTYPE html>
<html>
<body style="background-image:url(images/anu.jpg)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/anu1.jpg" width="30px" height="30px"><strong> Doctor Appointment Booking System</strong></a></li>
