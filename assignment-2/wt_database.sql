...
('user', 'patient', 'male', 1, 1, '2020-24-10', '2020-24-10 16:43:48', 'Booking Registered.Wait for the update');
...
(1, 'Clinic', 'XYZ apartment, CST', 'CST', 'HYD', 9347965936, '1');
...
(1, 'doctor', 'male', '1993-24-10', 10, 'Orthodontist', 9347965936, 'XYZ tower, CST', 'doctor', 'doctor', 'HYD');
...
(1, 'Manager', 'male', '1990-01-01', 9347965936, 'XYZ complex CST', 'manager', 'manager', 'HYD');
...
('user', 'male', '1985-01-01', 9347965936, 'user@test.com', 'user', 'user');
